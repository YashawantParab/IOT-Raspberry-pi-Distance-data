...
while True:
    ...
    print
    ts, reading  # print counts using GPIO4 and time
    ...
    time_end = time.time()
    if (counter >= 25 and (
            time_end - time_start) <= 60):  # if you get 25 measurements that indicate dry soil in less than one minute, need to water
...
GPIO.cleanup()
file.close()import RPi.GPIO as GPIO
import time
